...
@section('breadcrumb')
    <x-breadcrumb>
        ...
        <x-nav>
            ...
            <x-nav-item href="{{ route('special.create') }}">Create</x-nav-item>
        </x-nav>
    </x-breadcrumb>
@endsection
...
@section('content')
    <div class="col-lg-12 my-2 p-5 border rounded bg-white">
        <x-form method="POST" action="{{ route('special.store') }}" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
                    <x-input name="title" id="title" type="text" placeholder="Enter your title" value="{{ old('title') }}" />
                </div>
                <div class="col-md-6">
                    <x-input name="menu_name" id="menu_name" type="text" placeholder="Enter your menu_name" value="{{ old('menu_name') }}" />
                </div>
                ...
                <div class="col-md-12 my-2">
                    <x-textarea name="description" placeholder="enter text body">{{old('description')}}</x-textarea>
                </div>
                <div class="col-md-12">
