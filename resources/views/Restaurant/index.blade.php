            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
                ...
                <x-form action="" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <div class="form-group mt-3">
                                <x-input type="email" name="email" id="email" placeholder="Email[at]Example.com" value="{{ old('email') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 form-group">
                            <div class="form-group mt-3">
                                <x-textarea class="form-control" name="message" id="message" placeholder="Message" row="10">{{ old('message') }}</x-textarea>
                            </div>
                        </div>
